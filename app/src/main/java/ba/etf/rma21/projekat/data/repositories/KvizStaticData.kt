...
var mojiKvizovi: MutableList<Kviz> = listOf(
        ...
        Kviz("Kviz 2", "IM2", GregorianCalendar(2021, 4, 10).getTime(), GregorianCalendar(2021, 4, 11).getTime(), GregorianCalendar(1970, 0, 1).getTime(), 5, "IM21-1", null),
        ...
        Kviz("Kviz 1", "TP", GregorianCalendar(2021, 2, 12).getTime(), GregorianCalendar(2021, 2, 13).getTime(), GregorianCalendar(2021, 1, 12).getTime(), 3, "TP1-2", 1F),
        Kviz("Kviz 1", "TP", GregorianCalendar(2021, 3, 8).getTime(), GregorianCalendar(2021, 3, 20).getTime(), GregorianCalendar(1970, 0, 1).getTime(), 3, "TP1-2", null)
    ).toMutableList()
...
fun sviKvizovi() : List<Kviz> {
    return listOf(
        ...
        Kviz("Kviz 1", "IM2", GregorianCalendar(2021, 3, 2).getTime(), GregorianCalendar(2021, 3, 3).getTime(), GregorianCalendar(1970, 0, 1).getTime(), 10, "IM21-1", null),
        Kviz("Kviz 1", "IM2", GregorianCalendar(2021, 3, 9).getTime(), GregorianCalendar(2021, 3, 20).getTime(), GregorianCalendar(1970, 0, 1).getTime(), 10, "IM21-2", null),
        ...
        Kviz("Kviz 1", "DM", GregorianCalendar(2021, 1, 12).getTime(), GregorianCalendar(2021, 1, 13).getTime(), GregorianCalendar(1970, 0, 1).getTime(),3, "DM2-2", null),
