...
//    private var predmetIGrupaRepository = PredmetIGrupaRepository()
...
//            override fun onItemSelected(parent: AdapterView<*>?, view: View, position: Int, id: Long) {
//                val item_position = position.toString()
//                val grupe = predmetIGrupaRepository.getGroupsByPredmet(odabirPredmet.selectedItem.toString()).map { it.naziv }.stream().collect(Collectors.toList())
//
//                //DA SE OZNACI KOJI SE ELEMENT BIRA
